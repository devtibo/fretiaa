#ifndef QCPItemTracerBarsBARS_H
#define QCPItemTracerBarsBARS_H
#include "qcustomplot/qcustomplot.h"


class QCP_LIB_DECL QCPItemTracerBars : public QCPAbstractItem
{
    Q_OBJECT
...
public:
  ...
  */
    ...
    explicit QCPItemTracerBars(QCustomPlot *parentPlot);
    virtual ~QCPItemTracerBars();
    ...
    QCPBars *bars() const { return mBars; }
...
Q_DECLARE_METATYPE(QCPItemTracerBars::TracerStyle)
#endif // QCPItemTracerBarsBARS_H
